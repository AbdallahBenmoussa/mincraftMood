package net.abdallah.tutorialmod.block;
...
public class ModBlocks {
    ...
    public static final Block PLATINUM_BLOCK = registerBlock("platinum_block", new Block(FabricBlockSettings.copyOf(Blocks.DIAMOND_BLOCK)));
